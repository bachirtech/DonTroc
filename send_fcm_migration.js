...
const message = {
  topic: 'all_users',
  notification: {
    title: '📦 DonTroc : nouvelle façon de mettre à jour',
    body:
      "DonTroc n'est plus disponible sur le Play Store. " +
      'Téléchargez la dernière version (2.0) directement depuis notre site officiel.',
  },
  data: {
    action: 'open_url',
    url: DOWNLOAD_URL,
